...
/// info, the role classification, the BLAKE3-of-(dtype,shape,bytes) content hash,
/// and the resolved entity_id. Passes consume this list from the context;
/// individual passes never re-walk the safetensors files.
/// </summary>
