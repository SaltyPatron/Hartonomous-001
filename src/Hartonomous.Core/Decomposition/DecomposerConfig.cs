...
public sealed class DecomposerConfig
{
    ...
    /// processed by ModelDecomp — letting the foundation dependency chain run
    /// while ModelDecomp targets a specific subset (e.g., a small model for
    /// smoke-testing without paying the cost of decomposing every 33B-parameter
    /// model in the hub).
    /// </summary>
