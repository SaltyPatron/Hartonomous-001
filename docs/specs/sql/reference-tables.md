...
**Values**: `codepoint`, `grapheme_cluster`, `word_form`, `morpheme`, `lemma`, `ud_sentence`, `ud_token`, `tatoeba_sentence`, `text_composition`, `paragraph`, `document`, `pixel_region`, `audio_recording`, `audio_chunk`, `video_frame`, `tensor`, `model_architecture`, `attention_pattern`, `bpe_token`, `synset`, `word_sense`, `wikt_sense`, `inflected_form`, `collation_element`, `language_name`.
