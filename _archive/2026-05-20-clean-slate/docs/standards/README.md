...
| [sql.md](sql.md) | No inline SQL, naming conventions for all SQL objects, schema ownership, canonical schema and extension bootstrap rules. |
...
| [ingestion-pipeline.md](ingestion-pipeline.md) | The streaming ingestion pipeline. One writer surface, channel-owned bulk drains, producer deduplication, temp inflight COPY, decomposer relationship. |
