@echo off
.\scripts\Docker\Down.ps1 -RemoveVolumes -Force 2>&1 > logs\ShutDockerDown.log
.\scripts\build\All.ps1                         2>&1 > logs\BuildAll.log
.\scripts\Docker\Build.ps1                      2>&1 > logs\BuildContainer.log
...
.\scripts\db\Bootstrap.ps1                      2>&1 > logs\Bootstrap.log
.\scripts\test\Unicode.ps1                      2>&1 > logs\UnicodeDeterminism.log
...
.\scripts\seed\Text.ps1         -SourceRoot D:\Models 2>&1 > logs\SeedText.log
...
.\scripts\seed\Safetensors.ps1  -SourceRoot D:\Models 2>&1 > logs\SeedSafetensors.log
